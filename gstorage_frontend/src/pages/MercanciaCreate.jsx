...
import {
  Save, X, NotebookPen, User, MapPin, Map, Package, Scale,
  Box, FileText, AlertCircle, Loader2, ArrowLeft, Truck, Info
} from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-6 sm:p-8 space-y-8">
            ...
            <div>
              <h3 className="text-lg justify-between font-semibold text-gray-900 mb-4 flex items-center gap-2 border-b border-gray-100 pb-2">
