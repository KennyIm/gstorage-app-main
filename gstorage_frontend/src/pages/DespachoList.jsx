...
export default function DespachoList() {
  ...
  const filteredDespachos = despachos.filter(d =>
    (d.id_ruta && d.id_ruta.toLowerCase().includes(searchTerm.toLowerCase())) ||
    (d.id_conductor && d.id_conductor.toLowerCase().includes(searchTerm.toLowerCase())) ||
    (d.id_camion && d.id_camion.toLowerCase().includes(searchTerm.toLowerCase()))
  );
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          <div className="px-6 py-4 border-t border-gray-100 bg-gray-50/50 flex justify-between items-center text-xs text-gray-500">
            <span>Mostrando {filteredDespachos.length} registros</span>
          </div>
        </div>
