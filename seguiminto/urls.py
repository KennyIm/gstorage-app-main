...
from .views import RegistrarEntregaAPIView, RegistrarIncidenciaAPIView, ComprobanteEntregaViewSet, ConsultarControlEntregaAPIView,DespachosMovilActivosAPIView, MercanciasDespachoMovilAPIView, MercanciasSeguimientoDespachoAPIView, GenerarPresignedUrlPODAPIView
...
urlpatterns = [
    ...
    path('control-entrega/presigned-url/', GenerarPresignedUrlPODAPIView.as_view(), name='presigned_url_pod'),
    path('control-entrega/<int:id_mercancia>/registrar/', RegistrarEntregaAPIView.as_view(), name='registrar_entrega'),
